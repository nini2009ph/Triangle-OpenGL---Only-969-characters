# About
I made a triangle in OpenGl with only 967 characters of code! =D
# Code:
```cpp
#include <GL/glew.h>
...
float g[]={-.5,-.5,0,.5,.5,-.5};GLuint h;glGenBuffers(1,&h);glBindBuffer(0x8892,h);glBufferData(0x8892,24,g,0x88E4);
